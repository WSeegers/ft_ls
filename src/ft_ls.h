...
# define FLAGS "afglortuACLR"

# define FLAG_ALL				(SHIFT(0))
# define FLAG_NSORT				(SHIFT(1))
# define FLAG_NOOWNER			(SHIFT(2))
# define FLAG_LONG				(SHIFT(3))
# define FLAG_NOGRP				(SHIFT(4))
# define FLAG_REV				(SHIFT(5))
# define FLAG_TIME				(SHIFT(6))
# define FLAG_ACCESS			(SHIFT(7))
# define FLAG_AALL				(SHIFT(8))
# define FLAG_COL				(SHIFT(9))
# define FLAG_LINK				(SHIFT(10))
# define FLAG_REC				(SHIFT(11))
